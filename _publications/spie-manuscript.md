...
date: 2026-06-11
excerpt: "A modular ROS2-based pipeline dedicated to providing a solution for detection accuracy degradation and tracking detection dropout problems in vision-based UAV tracking through a comparative study of RF-DETR vs YOLOv8n perception models, as well as the application of Kalman-filter state estimations, PINN-based trajectory prediction, and PX4 offboard control tools."
abstract: > 
...
poster_pdf: "/files/SPIE_Poster.pdf"
---
